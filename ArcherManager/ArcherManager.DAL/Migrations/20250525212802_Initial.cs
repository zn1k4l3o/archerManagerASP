        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Competitions_Clubs_OrganiserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BowType = table.Column<int>(type: "int", nullable: false),
                    CompetitionType = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArcherResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArcherResults_Archers_ArcherId",
                        column: x => x.ArcherId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArcherResults_ArcherId",
                table: "ArcherResults",
                column: "ArcherId");

            migrationBuilder.CreateIndex(
                name: "IX_Archers_ClubId",
                table: "Archers",
                column: "ClubId");
